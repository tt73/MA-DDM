...
ax2.set_xlabel('SNES rtol', labelpad=10)
ax2.set_ylabel('KSP rtol', labelpad=10)
...
ax3.set_xlabel('SNES rtol', labelpad=10)
ax3.set_ylabel('KSP rtol', labelpad=10)
...
ax4.set_xlabel('SNES rtol', labelpad=10)
ax4.set_ylabel('KSP rtol', labelpad=10)
