...
printf "\nNGMRES with Newton NPC:\n"
mpiexec -np $np ../../maddm -N $N -problem ex1 -sub_snes_type ngmres -sub_snes_rtol 1e-2 -sub_ksp_rtol 1e-1 -sub_npc_snes_type newtonls -sub_npc_snes_linesearch_type l2 -sub_npc_snes_max_it 1
mpiexec -np $np ../../maddm -N $N -problem ex2 -sub_snes_type ngmres -sub_snes_rtol 1e-2 -sub_ksp_rtol 1e-1 -sub_npc_snes_type newtonls -sub_npc_snes_linesearch_type l2 -sub_npc_snes_max_it 1
mpiexec -np $np ../../maddm -N $N -problem ex3 -sub_snes_type ngmres -sub_snes_rtol 1e-2 -sub_ksp_rtol 1e-1 -sub_npc_snes_type newtonls -sub_npc_snes_linesearch_type l2 -sub_npc_snes_max_it 1
