...
mpiexec -np $np ../../maddm -N $N -problem ex1 -sub_snes_linesearch_type bt -sub_snes_linesearch_order 2 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
mpiexec -np $np ../../maddm -N $N -problem ex2 -sub_snes_linesearch_type bt -sub_snes_linesearch_order 2 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
mpiexec -np $np ../../maddm -N $N -problem ex3 -sub_snes_linesearch_type bt -sub_snes_linesearch_order 2 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
...
mpiexec -np $np ../../maddm -N $N -problem ex1  -sub_snes_linesearch_type basic -sub_snes_linesearch_damping 0.5 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
mpiexec -np $np ../../maddm -N $N -problem ex2  -sub_snes_linesearch_type basic -sub_snes_linesearch_damping 0.5 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
mpiexec -np $np ../../maddm -N $N -problem ex3  -sub_snes_linesearch_type basic -sub_snes_linesearch_damping 0.5 -sub_snes_max_it 1 -sub_ksp_rtol 1e-2
