...
for i in range(len(nps)):
   ...
   f.write("N=300\n")
   f.write("mpirun ../../maddm -N $N -problem ex1 -sub_snes_rtol 1e-1 -sub_ksp_rtol 1e-1 -snes_max_it 500\n")
   f.write("mpirun ../../maddm -N $N -problem ex2 -sub_snes_rtol 1e-1 -sub_ksp_rtol 1e-1 -snes_max_it 500\n")
   f.write("mpirun ../../maddm -N $N -problem ex3 -sub_snes_rtol 1e-1 -sub_ksp_rtol 1e-1 -snes_max_it 500\n")
   f.close()