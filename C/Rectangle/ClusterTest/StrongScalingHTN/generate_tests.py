...
for i in range(len(nps)):
   ...
   f.write("N=300\n")
   f.write("mpirun ../../maddm -N $N -problem ex1 -htn -op 0.3 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex2 -htn -op 0.3 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex3 -htn -op 0.3 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex4 -htn -op 0.3 >> out{:d}\n".format(nps[i]))
   f.close()