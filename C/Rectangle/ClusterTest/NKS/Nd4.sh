...
do
   ...
   do
      ...
      do
         ...
         mpiexec -np $Nd ../../maddm -N $N -nks  -problem ex1 -snes_type newtonls -snes_linesearch_order 2 -ksp_type pipefgmres -pc_type bjacobi -ksp_rtol $tol -snes_rtol $tol -xmin -$limit -xmax $limit -ymin -$limit -ymax $limit >> Nd4.out
      done
   done
done