...
for i in range(len(nps)):
   ...
   f.write("N=300\n")
   f.write("mpirun ../../maddm -N $N -problem ex1 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex2 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex3 >> out{:d}\n".format(nps[i]))
   f.write("mpirun ../../maddm -N $N -problem ex4 >> out{:d}\n".format(nps[i]))
   f.close()