...
plt.plot(nps,speedup1,'-', label='Ex1',marker='o',mfc='w',color=colors[0],ms=8)
plt.plot(nps,speedup2,':', label='Ex2',marker='s',mfc='w',color=colors[1],ms=8)
plt.plot(nps,speedup3,'--',label='Ex3',marker='^',mfc='w',color=colors[2],ms=8)
plt.plot(nps,speedup4,'.-',label='Ex4',marker='x',mfc='w',color=colors[3],ms=8)
