...
PetscErrorCode Poisson3DFunctionLocal(DMDALocalInfo *info, PetscReal ***au, PetscReal ***aF, PoissonCtx *user) {
   PetscErrorCode ierr;
   PetscInt   i, j, k;
...
PetscErrorCode Poisson2DJacobianLocal(DMDALocalInfo *info, PetscScalar **au, Mat J, Mat Jpre, PoissonCtx *user) {
   PetscErrorCode  ierr;
...
PetscErrorCode Poisson3DJacobianLocal(DMDALocalInfo *info, PetscScalar ***au, Mat J, Mat Jpre, PoissonCtx *user) {
   PetscErrorCode  ierr;
